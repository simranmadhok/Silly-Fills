...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        rl1.addView(new SquareTouch(this,null));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        switch (id)
        {
            case R.id.item1:
                ...
                Intent switch2 = new Intent(MainActivity.this, Splash_Screen.class);
            ...
            case R.id.item4:
                ...
                Intent switch3 = new Intent(MainActivity.this, Game_Instructions.class);
            ...
            case R.id.item5:
                ...
                Intent switch4 = new Intent(MainActivity.this, Game_Levels.class);
    ...
    public class SquareTouch extends View
    {
        ...
        public SquareTouch(Context context, AttributeSet attrs)
        {
            super(context, attrs);
        }
        ...
        protected void onDraw(Canvas canvas)
        {
            ...
            for(Point p : points)
            {
                ...
                canvas.drawRect(p.x, p.y, p.x+100, p.y+100,paint);
            ...
            public void onClick(DialogInterface dialogInterface, int i)
            {
                Thread thread = new Thread()
                {
                    ...
                    public void run()
                    {
                        ...
                        {
                            Intent switch4 = new Intent(MainActivity.this, Splash_Screen.class);
                            startActivity(switch4);
                        }
                    }
